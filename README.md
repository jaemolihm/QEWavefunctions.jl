...
[`examples/Si`](examples/Si): edit the tool paths at the top of
`examples/Si/run.sh` and run it. Only the inputs are tracked; all QE/Wannier90
outputs are generated by the script.
